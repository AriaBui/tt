...
{
    public class NDCPlayerRegistration : BaseScene
    {
        ...
        public NDCPlayerRegistration(Game game, IPlayerController playerController, ICarsController carsController, IGoalController goalController) : base(game, playerController, carsController, goalController)
        {
